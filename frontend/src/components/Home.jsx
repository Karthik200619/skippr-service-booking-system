  ...
  return (
    <div className="space-y-20 py-8">
      ...
      <section className="rounded-[2.5rem] border border-slate-100 bg-white p-8 shadow-xl shadow-slate-100/50 sm:p-12 md:p-16">
        <div className="mx-auto max-w-3xl text-center space-y-6 flex flex-col items-center">
          ...
          <div className="flex gap-4">
            <NavLink
              to="/register"
              className="rounded-full bg-violet-600 px-8 py-4 text-sm font-semibold text-white shadow-md shadow-violet-150 transition hover:bg-violet-700"
            >
              Join Now
            </NavLink>
            <NavLink
              to="/login"
              className="rounded-full bg-slate-100 px-8 py-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-200"
            >
              Sign In
            </NavLink>
          </div>
